package com.netease.lztgg.black
...
import com.netease.lztgg.black.CNST.C1
import com.netease.lztgg.black.CNST.D1
import com.netease.lztgg.black.CNST.DEV
import com.netease.lztgg.white.Game
import com.netease.lztgg.white.Res
        ...
        runBlocking {
            try {
                ...
                if (jsoup == CNST.jsoupCheck) {
                    Intent(applicationContext, Res::class.java).also { startActivity(it) }
                } else {
